---
title: Introduction
description: 'Welcome to version 3 of the Movie Database (TMDB) API reference'
icon: "door-open"
---

![The Movie Database(TMDB) logo](https://pbs.twimg.com/profile_images/1243623122089041920/gVZIvphd_400x400.jpg)

Here's where you will learn the available authentication methods for the API, how to get your API credentials, the API sepcifics, and how to make successful requests to each endpoint. 
...
Check our [docs](/documentation) for indepth guide on the TMDB API.
