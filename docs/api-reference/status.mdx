---
title: Status codes
description: An exhaustive list of API status codes and their meaning 
icon: "circle-check"
---

<Tip>
    Pay attention to the error messages in your response as they describe the error and its cause. 
    This helps you to troubleshoot efficiently.
</Tip>  

Below is a table showing the list of error codes and corresponding messages you might come across while using the TMDB API:
