...
and is also just kind of fun to see items chart up and down. You can think of popularity as being a "lifetime" score for a movie, tv show, etc that is impacted by 
the attributes below. 

Each media type builds their popularity value slightly differently. Here are some of the attributes we use to measure the popularity for each media type.
