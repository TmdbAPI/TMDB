...
description: Understand in details the concept of ppoularity and trending in the TMDB API.
icon: "fire"
---

## Popularity
Popularity is a fairly important metric here on TMDB. It helps us boost search results, adds an incredibly useful sort value for discover, 
