...
Visit the [API reference](https://emiloju.mintlify.app/api-reference/introduction) page to learn more on how the TMDB API works and how to get started right away.
